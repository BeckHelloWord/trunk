        ...
        components: {
            'list': {
                template: ' <div class="power-item">\
                                    <div v-for="val in list" v-link="{ name: \'vipIntroduce\', params: { id: val.levelProfitId }}"><div class="itemList">\
                                     <div class="img" v-bind:style="{ backgroundImage: \'url(https://bxwd-img.oss-cn-hangzhou.aliyuncs.com/\'+val.levelProfitIcon+\')\'}">\
                                </div>\
        ...
        created: function () {
            ...
            function get_vipdata() {
                ...
                API_GET({
                    ...
                    success: function (result) {
                        if(result.isSuccess){
                            that.myvip=result.data.levelName;
							...
							API_GET({
								...
								success: function (result) {
									if (result.isSuccess) {
										...
										that.ulwidth.width=result.data.length*7.25+"rem";
